...
ggsave(here("Graphs/Incidence of Chikungunya in Brazil.png"), incidence_chik_br, height = 15, width = 15, dpi = 300, create.dir = TRUE)
```
...
ggsave(here("Graphs/Incidence of Zika in Brazil.png"), incidence_zika_br, height = 15, width = 15, dpi = 300, create.dir = TRUE)
```
...
ggsave(here("Graphs/Incidence of Chikungunya per State.png"), incidence_chik_state, height = 15, width = 15, dpi = 300, create.dir = TRUE)
```
...
ggsave(here("Graphs/Incidence of Zika per State.png"), incidence_zika_state, height = 15, width = 15, dpi = 300, create.dir = TRUE)
```
...
ggsave(here("Graphs/Incidence of Chikungunya per Selected Municipalities.png"), incidence_chik_muni, height = 15, width = 15, dpi = 300, create.dir = TRUE)
```
...
ggsave(here("Graphs/Incidence of Zika per Selected Municipalities.png"), incidence_zika_muni, height = 15, width = 15, dpi = 300, create.dir = TRUE)
```
...
ggsave(here("Graphs/Deaths of Chikungunya in Brazil.png"), deaths_chik_br, height = 15, width = 15, dpi = 300, create.dir = TRUE)
```
...
ggsave(here("Graphs/Deaths of Zika in Brazil.png"), deaths_zika_br, height = 15, width = 15, dpi = 300, create.dir = TRUE)
```
...
ggsave(here("Graphs/Deaths of Chikungunya per State.png"), deaths_chik_state, height = 15, width = 15, dpi = 300, create.dir = TRUE)
```
...
ggsave(here("Graphs/Deaths of Zika per State.png"), deaths_zika_state, height = 15, width = 15, dpi = 300, create.dir = TRUE)
```
...
ggsave(here("Graphs/Deaths of Chikungunya per Selected Municipalities.png"), deaths_chik_muni, height = 15, width = 15, dpi = 300, create.dir = TRUE)
```
...
ggsave(here("Graphs/Deaths of Zika per Selected Municipalities.png"), deaths_zika_muni, height = 15, width = 15, dpi = 300, create.dir = TRUE)
```
...
ggsave(here("Graphs/Risk Levels of Dengue Outbreak in 2024 in Brazil with Emergency Dec.png"), dengue_risk_country, height = 8, width = 15, dpi = 300, create.dir = TRUE)
```
...
ggsave(here("Graphs/Risk Levels of Chikungunya Outbreak in 2024 in Brazil with Emergency Dec.png"), chik_risk_country, height = 8, width = 15, dpi = 300, create.dir = TRUE)
```
...
ggsave(here("Graphs/Risk Levels of Zika Outbreak in 2024 in Brazil with Emergency Dec.png"), zika_risk_country, height = 8, width = 15, dpi = 300, create.dir = TRUE)
```
...
ggsave(here("Graphs/Risk Levels of Arbovirus (Sum) Outbreak in 2024 in Brazil with Emergency Dec.png"), sum_risk_country, height = 8, width = 15, dpi = 300, create.dir = TRUE)
```
...
ggsave(here("Graphs/Risk Levels of Dengue Outbreak in 2024 per State with Emergency Dec.png"), dengue_risk_state, height = 12, width = 18, dpi = 300, create.dir = TRUE)
```
...
ggsave(here("Graphs/Risk Levels of Chikungunya Outbreak in 2024 per State with Emergency Dec.png"), chik_risk_state, height = 12, width = 18, dpi = 300, create.dir = TRUE)
```
...
ggsave(here("Graphs/Risk Levels of Zika Outbreak in 2024 per State with Emergency Dec.png"), zika_risk_state, height = 12, width = 18, dpi = 300, create.dir = TRUE)
```
...
ggsave(here("Graphs/Risk Levels of Arbovirus (Sum) Outbreak in 2024 per State with Emergency Dec.png"), sum_risk_state, height = 12, width = 18, dpi = 300, create.dir = TRUE)
```
...
ggsave(here("Graphs/Risk Levels of Dengue Outbreak in 2024 per Municipality with Emergency Dec.png"), dengue_risk_muni, height = 12, width = 18, dpi = 300, create.dir = TRUE)
```
...
ggsave(here("Graphs/Risk Levels of Chikungunya Outbreak in 2024 per Municipality with Emergency Dec.png"), chik_risk_muni, height = 12, width = 18, dpi = 300, create.dir = TRUE)
```
...
ggsave(here("Graphs/Risk Levels of Zika Outbreak in 2024 per Municipality with Emergency Dec.png"), zika_risk_muni, height = 12, width = 18, dpi = 300, create.dir = TRUE)
```
