...
# Dengue
dengue_risk_2024_country <- risk_2024_country %>%
  filter(virus == "Dengue") %>%
  ggplot(aes(x = week2, y = riskassessment, group = 1)) +
  geom_step(color = "firebrick") +
  labs(title = "Dengue Risk Assessment for Brazil in 2024", x = "Epidemiological Week", y = "Calculated Risk Level") +
  scale_y_continuous(breaks = 0:3, limits = c(0, 3)) +
  theme_bw()
print(dengue_risk_2024_country)
ggsave(here("Graphs/Dengue Risk Assessment for Brazil in 2024.png"), dengue_risk_2024_country, height = 15, width = 15, dpi = 600, create.dir = T)

# Zika
zika_risk_2024_country <- risk_2024_country %>%
  filter(virus == "Zika") %>%
  ggplot(aes(x = week2, y = riskassessment, group = 1)) +
  geom_step(color = "firebrick") +
  labs(title = "Zika Risk Assessment for Brazil in 2024", x = "Epidemiological Week", y = "Calculated Risk Level") +
  scale_y_continuous(breaks = 0:3, limits = c(0, 3)) +
  theme_bw()
print(zika_risk_2024_country)
ggsave(here("Graphs/Zika Risk Assessment for Brazil in 2024.png"), zika_risk_2024_country, height = 15, width = 15, dpi = 600, create.dir = T)

# Chikungunya
chik_risk_2024_country <- risk_2024_country %>%
  filter(virus == "Chikungunya") %>%
  ggplot(aes(x = week2, y = riskassessment, group = 1)) +
  geom_step(color = "firebrick") +
  labs(title = "Chikungunya Risk Assessment for Brazil in 2024", x = "Epidemiological Week", y = "Calculated Risk Level") +
  scale_y_continuous(breaks = 0:3, limits = c(0, 3)) +
  theme_bw()
print(chik_risk_2024_country)
ggsave(here("Graphs/Chikungunya Risk Assessment for Brazil in 2024.png"), chik_risk_2024_country, height = 15, width = 15, dpi = 600, create.dir = T)
```
...
epidemic_years_data_state <- results_state %>%
  mutate(epidemic_years = map(risk_analysis_results, extract_epidemic_years)) %>%
  select(uf, virus, epidemic_years) %>%
  unnest(cols = c(epidemic_years))
...
# Dengue
dengue_control_d_country <- risk_2024_country %>%
  filter(virus == "Dengue") %>%
  ggplot(aes(x = week2)) +
  ...
  labs(title = "Control Diagrams for Dengue Incidence in Brazil (2024)", y = "Incidence Rate (per 100,000)", x = "Epidemiological Week") +
  theme_bw() + theme(legend.position = "top")
print(dengue_control_d_country)
ggsave(here("Graphs/Control Diagrams for Dengue Incidence in Brazil 2024.png"), dengue_control_d_country, height = 15, width = 15, dpi = 600, create.dir = T)

# Zika
zika_control_d_country <- risk_2024_country %>%
  filter(virus == "Zika") %>%
  ggplot(aes(x = week2)) +
  geom_ribbon(aes(ymin = low, ymax = high), fill = "darkgrey", alpha = 0.8) +
  geom_line(aes(y = avg_incidence, linetype = "Historical Average", group = 1), color = "black") +
  geom_line(aes(y = incidence_current, linetype = "2024 Incidence", group = 1), color = "red") +
  scale_linetype_manual(name = "Legend", values = c("Historical Average" = "dashed", "2024 Incidence" = "solid")) +
  labs(title = "Control Diagrams for Zika Incidence in Brazil (2024)", y = "Incidence Rate (per 100,000)", x = "Epidemiological Week") +
  theme_bw() + theme(legend.position = "top")
print(zika_control_d_country)
ggsave(here("Graphs/Control Diagrams for Zika Incidence in Brazil 2024.png"), zika_control_d_country, height = 15, width = 15, dpi = 600, create.dir = T)

# Chikungunya
chik_control_d_country <- risk_2024_country %>%
  filter(virus == "Chikungunya") %>%
  ggplot(aes(x = week2)) +
  geom_ribbon(aes(ymin = low, ymax = high), fill = "darkgrey", alpha = 0.8) +
  geom_line(aes(y = avg_incidence, linetype = "Historical Average", group = 1), color = "black") +
  geom_line(aes(y = incidence_current, linetype = "2024 Incidence", group = 1), color = "red") +
  scale_linetype_manual(name = "Legend", values = c("Historical Average" = "dashed", "2024 Incidence" = "solid")) +
  labs(title = "Control Diagrams for Chikungunya Incidence in Brazil (2024)", y = "Incidence Rate (per 100,000)", x = "Epidemiological Week") +
  theme_bw() + theme(legend.position = "top")
print(chik_control_d_country)
ggsave(here("Graphs/Control Diagrams for Chikungunya Incidence in Brazil 2024.png"), chik_control_d_country, height = 15, width = 15, dpi = 600, create.dir = T)
```
...
# Dengue
dengue_risk_country <- risk_2024_country %>%
  filter(virus == "Dengue") %>%
  ggplot(aes(x = week2)) +
  ...
  labs(title = "Risk Levels of Dengue Outbreak in 2024 (Brazil", y = "Incidence Coefficient (per 100,000 inhabitants)", x = "Epidemiological Week")
print(dengue_risk_country)
ggsave(here("Graphs/Risk Levels of Dengue Outbreak in 2024 (Brazil.png"), dengue_risk_country, height = 15, width = 15, dpi = 600, create.dir = T)

# Zika
zika_risk_country <- risk_2024_country %>%
  filter(virus == "Zika") %>%
  ggplot(aes(x = week2)) +
  geom_rect(aes(xmin = week2, xmax = week2 + 1, ymin = low, ymax = high), fill = "darkgrey")+
  geom_rect(aes(xmin = week2, xmax = week2 + 1, ymin = 0, ymax = incidence_current, fill = riskassessment)) +
  ...
  theme(legend.position = "bottom") +
  scale_x_continuous(breaks = every_10_country) +
  labs(title = "Risk Levels of Zika Outbreak in 2024 (Brazil", y = "Incidence Coefficient (per 100,000 inhabitants)", x = "Epidemiological Week")
print(zika_risk_country)
ggsave(here("Graphs/Risk Levels of Zika Outbreak in 2024 (Brazil.png"), zika_risk_country, height = 15, width = 15, dpi = 600, create.dir = T)

# Chikungunya
chik_risk_country <- risk_2024_country %>%
  filter(virus == "Chikungunya") %>%
  ggplot(aes(x = week2)) +
  geom_rect(aes(xmin = week2, xmax = week2 + 1, ymin = low, ymax = high), fill = "darkgrey")+
  geom_rect(aes(xmin = week2, xmax = week2 + 1, ymin = 0, ymax = incidence_current, fill = riskassessment)) +
  ...
  theme(legend.position = "bottom") +
  scale_x_continuous(breaks = every_10_country) +
  labs(title = "Risk Levels of Chikungunya Outbreak in 2024 (Brazil", y = "Incidence Coefficient (per 100,000 inhabitants)", x = "Epidemiological Week")
print(chik_risk_country)
ggsave(here("Graphs/Risk Levels of Chikungunya Outbreak in 2024 (Brazil.png"), chik_risk_country, height = 15, width = 15, dpi = 600, create.dir = T)
```
...
dengue_risk_state <- risk_2024_state %>%
  ...
  facet_wrap(~uf, scales = "free_y", ncol = 4)
...
# 14. Emergency Declarations + Risk Levels in 2024 - Municipality Level

```{r emergency-muni}
# Manually create state emergency data from the provided table
...
# First, create a map from municipality to state to draw state lines on muni plots
muni_to_state_map <- arboviruses_muni %>%
  distinct(municipality, uf)

# Join the state emergency data with this map
emergency_state_for_muni_plot <- emergency_state %>%
  left_join(muni_to_state_map, by = "uf") %>%
  filter(!is.na(municipality))

# Plot for Dengue Risk Levels with Municipality and State Emergency Declarations
dengue_risk_emergency_muni <- risk_2024_muni %>%
  filter(virus == "Dengue") %>%
  ggplot(aes(x = week2)) +
  geom_rect(aes(xmin = week2, xmax = week2 + 1, ymin = low, ymax = high), fill = "darkgrey") +
  geom_rect(aes(xmin = week2, xmax = week2 + 1, ymin = 0, ymax = incidence_current, fill = riskassessment)) +
  geom_line(aes(y = avg_incidence, color = "Average Incidence", linetype = "Average Incidence"), size = 1) +
  # Add vertical line for STATE emergency declarations (SOLID)
  geom_vline(data = emergency_state_for_muni_plot, aes(xintercept = week2), color = "black", linetype = "solid", size = 1) +
  # Add vertical line for MUNICIPALITY emergency declarations (DASHED)
  geom_vline(data = emergency_muni, aes(xintercept = week2), color = "black", linetype = "dashed", size = 1) +
  theme_bw() +
  scale_color_manual(name = "Legend", values = c("Average Incidence" = "blue")) +
  scale_linetype_manual(name = "Legend", values = c("Average Incidence" = "dashed")) +
  scale_fill_manual(name = "Risk Level & Baseline", values = c("0" = "#07E000", "1" = "#D9E000", "2" = "#E07000", "3" = "#E10000"), labels = c("0" = "Level 0 - Normal", "1" = "Level 1 - Alert", "2" = "Level 2 - High", "3" = "Level 3 - Epidemic")) +
  ...
  scale_x_continuous(breaks = every_10_muni) +
  labs(
    title = "Dengue Risk and Emergency Declarations in 2024 (Municipalities)",
    subtitle = "Solid Line = State Declaration | Dashed Line = Municipal Declaration",
    y = "Incidence (per 100,000 inhabitants)",
    x = "Epidemiological Week"
  ) +
  facet_wrap(~municipality, scales = "free_y", ncol = 4)

print(dengue_risk_emergency_muni)
ggsave(here("Graphs/Risk Levels of Dengue with Emergency (Municipalities).png"), dengue_risk_emergency_muni, height = 15, width = 15, dpi = 600, create.dir = T)
```
