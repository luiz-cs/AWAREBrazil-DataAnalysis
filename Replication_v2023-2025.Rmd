...
# Prepare the data for state-level regressions
...
tbl_states_final <- tbl_merge(
  ...
  modify_caption("Association Between High-Risk Duration and State Emergency Declaration")
...
tbl_munis_final <- tbl_merge(
  ...
  modify_caption("Association Between High-Risk Duration and Municipal Emergency Declaration")

# Display the final tables
tbl_states_final
tbl_munis_final

# --- 4. Save Tables to a Word Document ---
# This part is optional but useful for manuscript preparation
